...
import dog from '../../static/dog_blanket.jpg';
import streaming from '../../static/hulu_netflix.jpg';

const VisitInfo = () => {
    return(
        <div className={classes.VisitInfo}>
            <Row className={classes.Intro}>
                <Col xs={12} md={12} lg={4} xl={{span: 2, offset: 2}}>
                ...
                <Col xs={12} md={12} lg={4} xl={2} className={classes.Visit}>
                    <h3>Your Visit</h3>
                ...
                <Col xs={12} md={6} lg={4} xl={2} className={classes.Card}>
            ...
            <Row className={classes.Amenities}>
                ...
                <Col xs={12} md={6} lg={6} xl={{span: 2, offset: 2}}>
                ...
                <Col xs={12} md={6} lg={6} xl={2} className={classes.Staggered}>
